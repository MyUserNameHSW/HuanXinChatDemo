...
public class DemoHXSDKHelper extends HXSDKHelper{
    ...
    protected void initEventListener() {
        eventListener = new EMEventListener() {
            ...
            public void onEvent(EMNotifierEvent event) {
                ...
                EMLog.i("ssss", "DemoHXSDKHelper--" + ((EMMessage)event.getData()).getBody().toString());
    ...
    EMContactListener MyContactListener = new EMContactListener() {
        
        @Override
        public void onContactRefused(String arg0) {
            EMLog.i("DemoHXSDKHelper", "onContactRefused--" + arg0);
            
        }
        
        @Override
        public void onContactInvited(String arg0, String arg1) {
            EMLog.i("DemoHXSDKHelper", "onContactInvited--" + arg0);
            
        }
        
        @Override
        public void onContactDeleted(List<String> arg0) {
            EMLog.i("DemoHXSDKHelper", "onContactDeleted--" + arg0.toString());
            
        }
        
        @Override
        public void onContactAgreed(String arg0) {
            EMLog.i("DemoHXSDKHelper", "onContactDeleted--" + arg0);
            
        }
        
        @Override
        public void onContactAdded(List<String> arg0) {
            EMLog.i("DemoHXSDKHelper", "onContactAdded--" + arg0.toString());
    ...
    protected void onConnectionConflict(){
        Log.i("ssss", "onConnectionConflict");
