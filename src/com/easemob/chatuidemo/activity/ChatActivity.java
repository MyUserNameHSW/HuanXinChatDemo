...
public class ChatActivity extends BaseActivity implements OnClickListener, EMEventListener{
	...
	public void onClick(View view) {
		...
		} else if(id == R.id.btn_service_msg) {
		    String s = mEditTextContent.getText().toString();
		    sendServiceMsg("http://www.jd.com/");
		}
	}
	...
	private void sendServiceMsg(String content) {
//	    EMMessage CMDmessage = EMMessage.createReceiveMessage(EMMessage.Type.CMD);
//	    String action = "ServiceMessage";
//	    CmdMessageBody cmdBody = new CmdMessageBody(action);
//	    CMDmessage.setAttribute("type", 1);
...
//                Log.i("ssss", "SendServiceMsgError");
//                
//            }
//
//            @Override
...
//                Log.i("ssss", "SendServiceMsgSuccess");
//                
//            }
//	        
//	    });
	    ...
	    message.setAttribute(Constant.MESSAGE_ATTR_IS_SERVICE_ADD, true);
	    message.setReceipt(toChatUsername);
	    conversation.addMessage(message);
