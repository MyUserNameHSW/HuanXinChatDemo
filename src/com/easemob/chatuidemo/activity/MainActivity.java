...
//					unreadAddressLable.setText(String.valueOf(count));
	...
	public class MyContactListener implements EMContactListener {
		...
		public void onContactAdded(List<String> usernameList) {	
		    EMLog.i("MainActivity", "onContactAdded : " + usernameList.toString());
			// 保存增加的联系人
		...
		public void onContactDeleted(final List<String> usernameList) {
		    EMLog.i("MainActivity", "onContactDeleted : " + usernameList.toString());
			// 被删除
			Map<String, User> localUsers = DemoApplication.getInstance().getContactList();
			for (String username : usernameList) {
		...
		public void onContactInvited(String username, String reason) {
		    EMLog.i("MainActivity", "onContactInvited : " + username + "--" + reason);
